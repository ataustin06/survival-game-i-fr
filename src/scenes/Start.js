...
showFloodPreparationQuestion ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        400,
        'Le groupe devrait-il passer son temps à obtenir de la nourriture pour la journée ou à préparer l’endroit pour résister aux inondations dans quelques semaines ?',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
    ...
    const answers = Phaser.Utils.Array.Shuffle([
'Le groupe devrait passer son temps à obtenir de la nourriture pour la journée.',
'Le groupe devrait passer son temps à préparer l’endroit pour résister aux inondations dans deux semaines.'
    ]);
...
saveGameDataToGoogleSheets ()
{
    const googleScriptUrl =
        'https://script.google.com/macros/s/AKfycby6gcK1d-XZdMZ24C6Xuv1z86aTPyMpByKLTzYL3kGtKLjz5_l37AEewSqNufki4vdU/exec';
