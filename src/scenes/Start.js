...
create ()
{
    this.cameras.main.setBackgroundColor('#9b9b9b');

this.gameData = {
    gameId: null,
    condition: "insufficiency",
    gameVersion: "insufficiency_french_v1",
...
redistributionRulesSelected: {
    ...
    this.instructionScreens = [
        ...
        'L’endroit est pauvre en ressources naturelles et ne dispose pas toujours de suffisamment de nourriture pour que tous les membres du groupe survivent.',
        'La Personne A récolte toujours le plus grand nombre de morceaux de nourriture par jour. \n \nLa Personne B récolte toujours un nombre intermédiaire de morceaux de nourriture par jour. \n \nLa Personne C récolte toujours le moins de morceaux de nourriture par jour.',
        'Aujourd’hui, la Personne A a récolté 6 morceaux de nourriture, la Personne B a récolté 5 morceaux de nourriture et la Personne C a récolté 1 morceau de nourriture. \n \nIl arrive parfois que certaines personnes récoltent plus ou moins de nourriture qu’aujourd’hui.',
...
showRotatePhoneScreen (nextFunction)
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        310,
        'Si vous utilisez un téléphone portable, veuillez le faire pivoter en mode paysage pour continuer.',
        {
            fontSize: '34px',
            color: '#000000',
            align: 'center',
    ...
    this.createNextButton(640, 520, 'Suivant', () => {
...
this.addQuestionObject(
    ...
    showSurvivalCheckFeedback (message)
    {
        ...
        this.createNextButton(640, 520, 'Commencer le jeu', () => {
    ...
    startFoodCollectionTask ()
{
    ...
    const personA = this.createHumanAvatar(170, baselineY, 'Personne A', 1.08, 0xcc3333, 0);
    const personB = this.createHumanAvatar(450, baselineY, 'Personne B', 1.00, 0x3366cc, 0);
    const personC = this.createHumanAvatar(730, baselineY, 'Personne C', 1.00, 0x339966, 0);
...
showFoodCollectionNextButtonIfReady ()
{
    const allThreeCollected =
        this.foodCounts['Personne A'] > 0 &&
        this.foodCounts['Personne B'] > 0 &&
        this.foodCounts['Personne C'] > 0;
    ...
    if (person === 'Personne C')
{
    ...
    this.gameData.treeFruitCollected.personC = 1;
    ...
    showDistributionDisplay ()
{
    ...
    this.addQuestionObject(this.add.text(150, 550,
        'Faites glisser et déposez chaque morceau de nourriture en tas sur la couverture afin de compter combien de morceaux de nourriture le groupe a récoltés.',
        {
            fontSize: '24px',
            color: '#000000',
            align: 'center',
        ...
        food.on('dragend', () => {
            ...
            if (Phaser.Geom.Rectangle.Contains(blanketBounds, food.x, food.y))
            {
                if (!food.counted)
                {
                    ...
                    this.blanketCounterText.setText(`Morceaux comptés : ${this.blanketFoodCount}`);
    ...
    showTotalFoodEstimateQuestion ()
{
    ...
    this.addQuestionObject(
        this.add.text(
            640,
            220,
            'Selon vous, combien de morceaux de nourriture le groupe a-t-il récoltés aujourd\'hui au total ?',
            {
                fontSize: '30px',
                color: '#000000',
                align: 'center',
 ...
 showEqualDivisionTask ()
{
    ...
    this.addQuestionObject(this.add.text(
        145,
        35,
        'Réfléchissez à ce qui se passera si le groupe répartit la nourriture de manière égale. Faites glisser chaque morceau de nourriture de la couverture vers chaque personne.',
        {
            fontSize: '25px',
            color: '#000000',
            align: 'center',
...
showSurvivalGoalReminderScreen ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        315,
        'Rappelez-vous, votre tâche est de prendre des décisions au nom du groupe afin de maximiser la survie du plus grand nombre de membres du groupe.',
        {
            fontSize: '30px',
            color: '#000000',
            align: 'center',
...
const personCDisplayFood = fixedFood.personC;
    ...
    this.addQuestionObject(this.add.text(
        640,
        345,
        'Comment le groupe devrait-il répartir la nourriture entre les membres du groupe ?',
        {
            fontSize: '29px',
            color: '#000000',
            align: 'center',
    ...
    const answers = Phaser.Utils.Array.Shuffle([
        'Le groupe devrait répartir la nourriture de manière égale entre les membres du groupe.',
    ...
    showPartialRedistributionTask ()
{
    ...
    this.partialRedistributionCounts = {
        'Personne A': fixedFood.personA,
        'Personne B': fixedFood.personB,
        'Personne C': fixedFood.personC
    };
    ...
    this.addQuestionObject(this.add.text(
        140,
        30,
        'Répartissez maintenant la nourriture de la manière qui, selon vous, maximisera le nombre de personnes qui survivront aujourd\'hui et à l\'avenir.',
        {
            fontSize: '25px',
            color: '#000000',
            align: 'center',
    ...
    this.addQuestionObject(this.createStaticHumanAvatar(260, baselineY, 'Personne A', 1.05, 0xcc3333, 0));
    this.addQuestionObject(this.createStaticHumanAvatar(640, baselineY, 'Personne B', 1.00, 0x3366cc, 0));
    this.addQuestionObject(this.createStaticHumanAvatar(1020, baselineY, 'Personne C', 0.90, 0x339966, 0));

    this.personDropZones = {
        'Personne A': this.add.zone(260, baselineY + 25, 210, 270).setRectangleDropZone(210, 270),
        'Personne B': this.add.zone(640, baselineY + 25, 210, 270).setRectangleDropZone(210, 270),
        'Personne C': this.add.zone(1020, baselineY + 25, 210, 270).setRectangleDropZone(210, 270)
    };
...
createPartialRedistributionFoodPieces ()
{
    ...
    const people = [
        { label: 'Personne A', amount: fixedFood.personA },
        { label: 'Personne B', amount: fixedFood.personB },
        { label: 'Personne C', amount: fixedFood.personC }
    ];
        ...
        if (!this.partialRedistributionNextShown)
        {
            ...
            this.createNextButton(640, 675, 'Suivant', () => {
                this.gameData.partialRedistributionFinal.personA =
                    this.partialRedistributionCounts['Personne A'];

                this.gameData.partialRedistributionFinal.personB =
                    this.partialRedistributionCounts['Personne B'];

                this.gameData.partialRedistributionFinal.personC =
                    this.partialRedistributionCounts['Personne C'];
...
showPartialRedistributionPreferenceQuestion ()
{
    ...
    this.addQuestionObject(this.createStaticHumanAvatar(260, 125, 'Personne A', 0.78, 0xcc3333, fixedFood.personA));
    this.addQuestionObject(this.createStaticHumanAvatar(640, 125, 'Personne B', 0.72, 0x3366cc, fixedFood.personB));
    this.addQuestionObject(this.createStaticHumanAvatar(980, 125, 'Personne C', 0.66, 0x339966, fixedFood.personC));
    ...
    const answers = Phaser.Utils.Array.Shuffle([
        'Toute personne ayant plus de 5 morceaux de nourriture devrait partager son surplus de nourriture avec une autre personne qui a besoin de davantage de nourriture pour survivre.',
        'Chaque membre du groupe devrait conserver les morceaux de nourriture qu’il a récoltés.'
    ]);
...
showRedistributionRulesQuestion ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        160,
        'Laquelle des distributions suivantes maximiserait le nombre de personnes qui survivent aujourd\'hui et à l\'avenir ? Cochez toutes les réponses qui s\'appliquent.',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
   ...
   const options = Phaser.Utils.Array.Shuffle([
    {
        label: 'Chaque personne garde la nourriture qu\'elle a récoltée.',
        key: 'noRedistribution'
    },
    {
        label: 'Le groupe répartit la nourriture également entre tous les membres.',
        key: 'equalRedistribution'
    },
    {
        label: 'Toute personne ayant plus de 5 morceaux de nourriture devrait partager son surplus de nourriture avec une autre personne qui a besoin de davantage de nourriture pour survivre.',
...
const personCDisplayFood = fixedFood.personC;
    ...
    this.addQuestionObject(this.add.text(210, 325,
        'La Personne A devrait-elle partager sa nourriture avec la Personne C, ou devrait-elle conserver sa nourriture pour la manger elle-même un autre jour ?',
        {
            fontSize: '28px',
            color: '#000000',
            align: 'center',
...
showSocialContractQuestion ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        235,
        'Le groupe peut-il former un contrat social garantissant que chaque membre disposera toujours de la quantité minimale de nourriture nécessaire pour survivre ?',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
    ...
    const answers = Phaser.Utils.Array.Shuffle([
        'Oui, le groupe peut former un contrat social garantissant que chaque membre disposera toujours de la quantité minimale de nourriture nécessaire pour survivre.',
        'Non, le groupe ne peut pas former un contrat social garantissant que chaque membre disposera toujours de la quantité minimale de nourriture nécessaire pour survivre.'
    ]);
...
showPersonalVsGroupResponsibilityQuestion ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        230,
        'Pour que le plus grand nombre de personnes survive aujourd’hui et à l’avenir, est-il plus important que chaque membre du groupe prenne la responsabilité personnelle de récolter suffisamment de nourriture pour survivre lui-même ou qu’il prenne la responsabilité de veiller à ce que tous les membres du groupe aient suffisamment de nourriture pour survivre ?',
        {
            fontSize: '25px',
            color: '#000000',
            align: 'center',
    ...
    const answers = Phaser.Utils.Array.Shuffle([
        'Il est plus important que chaque membre du groupe prenne la responsabilité de veiller à ce que tous les membres du groupe aient suffisamment de nourriture pour survivre.',
        'Il est plus important que chaque membre du groupe prenne la responsabilité personnelle de récolter suffisamment de nourriture pour survivre lui-même.'
    ]);
...
showFairRuleQuestion ()
{
    ...
    const answers = Phaser.Utils.Array.Shuffle([
        'Une règle juste serait que les trois personnes partagent toujours équitablement leur nourriture lorsqu’elles chassent et récoltent plus de 5 morceaux en une journée.',
        'Une règle juste serait que la quantité de nourriture que chaque personne mange soit proportionnelle à la quantité qu’elle récolte elle-même.'
    ]);
...
this.addQuestionObject(this.createStaticHumanAvatar(1000, 185, 'Personne C', 0.88, 0x339966, fixedFood.personC));
    ...
    this.addQuestionObject(this.add.text(
        640,
        450,
        'Rappelez-vous, la Personne A récolte toujours le plus grand nombre de morceaux de nourriture par jour. La Personne B récolte toujours un nombre moyen de morceaux de nourriture par jour. La Personne C récolte toujours le moins de morceaux de nourriture par jour.',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
...
showFoodPriorityQuestion ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        285,
        'Les besoins alimentaires de quelle personne le groupe devrait-il prioriser afin de maximiser le nombre de personnes qui restent en vie ?',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
    ...
    const answers = Phaser.Utils.Array.Shuffle([
        ...
        'Le groupe devrait s’assurer que la Personne A reçoive au moins 5 morceaux de la nourriture récoltée chaque jour, parce que la Personne A est généralement capable de partager le plus de nourriture et parce qu’elle est la plus susceptible de survivre à long terme.'
    ]);
...
showWorkBreakQuestion ()
{
    ...
    this.addQuestionObject(this.add.text(
        650,
        340,
        'Un jour, l’une des personnes est épuisée et souhaite faire une pause dans la chasse et la récolte de nourriture. Cette personne devrait-elle continuer à travailler ou faire une pause ?',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
    ...
    const answers = Phaser.Utils.Array.Shuffle([
        ...
        'La personne devrait continuer à chasser et récolter de la nourriture.'
    ]);
...
drawFloodTaskTree (x, y)
{
    ...
    branches.forEach(branch => {
        ...
        b.setAngle(branch.angle);
        this.addQuestionObject(b);
    });

    // Trunk second so it covers the bases of the lower branches
    const trunk = this.add.rectangle(1085 + sx, 400 + sy, 44, 165, trunkColor);
    trunk.setAngle(-2);
    trunk.setDepth(5);
    this.addQuestionObject(trunk);

    // Small cap at split point instead of a hole
    const splitCover = this.add.circle(1085 + sx, 332 + sy, 13, trunkColor);
    splitCover.setDepth(6);
    this.addQuestionObject(splitCover);
...
showFloodPreparationQuestion ()
{
    ...
    this.addQuestionObject(this.add.text(
        650,
        400,
        'Le groupe devrait-il passer le reste de la journée à chercher davantage de nourriture à manger ou à préparer l\'endroit afin de résister à des inondations dans quelques semaines ?',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
    ...
    const answers = Phaser.Utils.Array.Shuffle([
        'Le groupe devrait passer le reste de la journée à chercher davantage de nourriture à manger.',
        'Le groupe devrait passer le reste de la journée à préparer l\'endroit afin de résister à des inondations dans deux semaines.'
    ]);
...
showPersonDInstructionScreen ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        165,
        'Une nouvelle personne (Personne D) entre dans l’endroit où se trouve le groupe et supplie qu’on lui donne de la nourriture. Cette nouvelle personne est pacifique et ne représente aucune menace.',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
...
showPersonDShareQuestion ()
{
    ...
    this.addQuestionObject(this.createPersonDOutstretchedAvatar(640, 125, 'Personne D', 0.82, 0x8a5a44));
...
showPersonDEmpathyQuestion ()
{
    ...
    this.addQuestionObject(this.add.text(
        650,
        325,
        'Le groupe maximise-t-il le nombre de personnes susceptibles de survivre s’il éprouve une grande empathie pour la Personne D ou s’il limite ses sentiments d’empathie envers la Personne D ?',
        {
            fontSize: '26px',
            color: '#000000',
            align: 'center',
    ...
    const answers = Phaser.Utils.Array.Shuffle([
        'Le groupe maximise le nombre de personnes susceptibles de survivre s’il éprouve une grande empathie pour la Personne D.',
        'Le groupe maximise le nombre de personnes susceptibles de survivre s’il éprouve un minimum d’empathie pour la Personne D.'
    ]);
...
showCooperationCompetitionInstructionScreen ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        120,
        'La plupart des gens coopèrent parfois avec les autres et rivalisent parfois avec les autres.',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
...
const personCDisplayFood = fixedFood.personC;
    ...
    this.addQuestionObject(this.add.text(
        640,
        330,
        'Pensez-vous que les personnes de ce groupe sont probablement plus coopératives ou plus compétitives ?',
        {
            fontSize: '28px',
            color: '#000000',
            align: 'center',
    ...
    const answers = Phaser.Utils.Array.Shuffle([
        'Les personnes de ce groupe sont probablement plus compétitives.',
        'Les personnes de ce groupe sont probablement plus coopératives.'
    ]);
...
showFinalGameScreen ()
{
    ...
    this.time.delayedCall(
        ...
        {
            statusText.setText(
                'Merci d’avoir terminé le jeu de survie.\n\nVos réponses ont été enregistrées.\n\nVeuillez fermer cet onglet et retourner au questionnaire.'
            );
                ...
                () =>
                {
                    ...
                    this.addQuestionObject(
                        this.add.text(
                            640,
                            630,
                            'Si cet onglet ne se ferme pas automatiquement, fermez-le manuellement et retournez à l’onglet du questionnaire.',
                            {
                                fontSize: '22px',
                                color: '#000000',
                                align: 'center',
...
createNextButton (x, y, label, callback)
{
    ...
    const isStartButton = label === 'Commencer le jeu';

    const buttonWidth = isStartButton ? 300 : style.width;
    const fontSize = isStartButton ? '26px' : style.fontSize;
