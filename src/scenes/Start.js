...
this.createSurvivalCheckButton(640, 340, '3 morceaux de nourriture', false);
this.createSurvivalCheckButton(640, 420, '5 morceaux de nourriture', true);
this.createSurvivalCheckButton(640, 500, '7 morceaux de nourriture', false);
}
    ...
    startFoodCollectionTask ()
{
    ...
    this.createGameNextButton(640, 650, 'Suivant', () => {
...
addFoodToBasket (avatar, amount)
{
    for (let i = 0; i < amount; i++)
    {
        ...
        const appleX = 39 + ((position % 3) - 1) * 12;
        const appleY = 25 + Math.floor(position / 3) * 13;
    ...
    showTotalFoodEstimateQuestion ()
{
    ...
    this.addQuestionObject(
        this.add.text(
            640,
            220,
            'Combien estimez-vous que le groupe a récolté de morceaux de nourriture au total aujourd’hui ?',
            {
                fontSize: '30px',
                color: '#000000',
                align: 'center',
...
showEqualDivisionTask ()
{
    ...
    this.addQuestionObject(this.add.text(
        145,
        35,
        'Imaginez ce qui se passera si le groupe divise la nourriture également. Faites glisser et déposez les morceaux de nourriture de la couverture vers chaque personne.',
        {
            fontSize: '25px',
            color: '#000000',
            align: 'center',
...
createEqualDivisionFoodPieces (totalFood)
{
    ...
    showPerCapitaQuestion ()
    {
        ...
        this.addQuestionObject(this.add.text(230, 170,
            'Si les trois membres du groupe divisent également entre eux le nombre total de morceaux de nourriture qu’ils ont récoltés aujourd’hui, combien de morceaux chaque personne recevra-t-elle ?',
            {
                fontSize: '28px',
                color: '#000000',
                align: 'center',
...
showSurvivalGoalReminderScreen ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        315,
        'Souvenez-vous, votre tâche est de prendre des décisions au nom du groupe afin de maximiser la survie du plus grand nombre de membres du groupe.',
        {
            fontSize: '30px',
            color: '#000000',
            align: 'center',
...
const personCDisplayFood = fixedFood.personC;
    ...
    this.addQuestionObject(this.add.text(
        640,
        345,
        'Comment le groupe devrait-il distribuer la nourriture parmi les membres du groupe ?',
        {
            fontSize: '29px',
            color: '#000000',
            align: 'center',
    ...
    const answers = Phaser.Utils.Array.Shuffle([
'Le groupe devrait diviser la nourriture également entre les membres du groupe.',
'Chaque membre du groupe devrait garder les morceaux de nourriture qu’il a récoltés.'
    ]);
...
showFairRuleQuestion ()
{
    ...
    const answers = Phaser.Utils.Array.Shuffle([
  'Une règle juste serait que les trois personnes doivent toujours partager leur nourriture équitablement chaque fois qu’elles chassent et récoltent plus de 5 morceaux dans une journée.',
...
this.addQuestionObject(this.createStaticHumanAvatar(1000, 185, 'Personne C', 0.88, 0x339966, fixedFood.personC));
    ...
    this.addQuestionObject(this.add.text(
        640,
        450,
        'Souvenez-vous, la Personne A récolte toujours le plus grand nombre de morceaux de nourriture par jour. La Personne B récolte toujours un nombre moyen de morceaux de nourriture par jour. La Personne C récolte toujours le moins de morceaux de nourriture par jour.',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
...
showFoodPriorityQuestion ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        285,
        'À quelles personnes le groupe devrait-il donner la priorité pour les besoins en nourriture afin de maximiser le nombre de personnes qui restent en vie ?',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
...
showHardWorkReminderScreen ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        480,
        'La chasse et la récolte de nourriture sont un travail difficile.',
        {
            fontSize: '30px',
            color: '#000000',
            align: 'center',
...
this.addQuestionObject(this.add.rectangle(640, 445, 1120, 360, 0xffffff))
        .setStrokeStyle(4, 0x000000);

    this.addQuestionObject(this.add.text(
        640,
        340,
        'Un jour, l’une des personnes est épuisée et veut faire une pause dans la chasse et la récolte de nourriture. La personne devrait-elle continuer à travailler ou faire une pause ?',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
...
showPersonDInstructionScreen ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        165,
        'Une nouvelle personne (la Personne D) arrive dans l’endroit où se trouve le groupe et supplie qu’on lui donne de la nourriture. La nouvelle personne est pacifique et ne représente pas une menace.',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
...
showPersonDShareQuestion ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        325,
        'Les membres du groupe devraient-ils partager leur nourriture avec la Personne D ou demander à la Personne D d’obtenir de la nourriture ailleurs ?',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
...
'Les membres du groupe devraient demander à la Personne D d’obtenir de la nourriture ailleurs.'
    ]);
...
this.addQuestionObject(this.add.rectangle(640, 430, 1120, 350, 0xffffff))
    ...
    const answers = Phaser.Utils.Array.Shuffle([
        'Le groupe maximise le nombre de personnes susceptibles de survivre s’il éprouve de grands sentiments d’empathie pour la Personne D.',
'Le groupe maximise le nombre de personnes susceptibles de survivre s’il éprouve des sentiments minimaux d’empathie pour la Personne D.'
    ]);
...
showCooperationCompetitionInstructionScreen ()
{
    ...
    this.addQuestionObject(this.add.text(
        640,
        120,
        'La plupart des personnes coopèrent parfois avec les autres et sont parfois en compétition avec les autres.',
        {
            fontSize: '27px',
            color: '#000000',
            align: 'center',
...
showFinalGameScreen ()
{
    ...
    .then(() => {
        console.log('La requête d’enregistrement dans Google Sheets a été envoyée.');
    })
    .catch(error => {
        console.error('L’enregistrement dans Google Sheets a échoué :', error);
    });
